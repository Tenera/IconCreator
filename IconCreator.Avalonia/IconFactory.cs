...
public static class IconFactory
{
    ...
    public static void CreateMultiImageIcon(string sourceImage, string destinationImage)
    {
        ...
        ValidateSize(new global::Avalonia.Size(source.Width, source.Height));
    ...
    public static void ValidateSize(global::Avalonia.Size size)
    {
        const double TOLERANCE = 0.000001;
        if (Math.Abs(size.Width - size.Height) > TOLERANCE || size.Width < 256)
        {
